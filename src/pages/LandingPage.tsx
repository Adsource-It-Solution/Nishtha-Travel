...
import { Compass, ShieldCheck, Award, ArrowRight, Play, CheckCircle2, Send, Flame } from 'lucide-react';
...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="relative bg-brand-light" id="top">
      ...
      <section className="relative min-h-[90vh] flex items-center pt-28 pb-16 overflow-hidden border-b border-[#E5E0D8]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-left">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[11px] font-bold uppercase tracking-[0.3em] text-brand-purple font-serif">
                  01 / BESPOKE CONCIERGE
                </span>
              </div>

              {/* Large Luxury Serif Typography */}
              <div className="space-y-6">
                <h1 className="text-4xl sm:text-6xl lg:text-7.5xl font-medium font-serif text-brand-blue tracking-tight leading-[1.1]">
                  The Art of <br />
                  <span className="italic font-normal">Bespoke Sanctuary</span> Travel
                </h1>
                
                <p className="text-slate-600 text-xs sm:text-sm max-w-xl font-normal leading-relaxed tracking-wide">
                  Nishtha Travel Concierge curates ultra-luxury overwater sanctuaries, private aviation suites, and customized global itineraries. Designed for the discerning globetrotter seeking timeless comfort.
                </p>
              </div>

              {/* Minimal CTA link */}
              <div className="flex flex-wrap items-center gap-6 pt-2">
                <a href="#destinations" className="btn-gold rounded-none">
                  Explore Destinations
                </a>
                <a href="/about" className="text-xs font-bold uppercase tracking-[0.2em] text-brand-blue hover:text-brand-purple transition-colors flex items-center gap-2 border-b border-brand-blue pb-0.5">
                  <span>Our Story</span>
            ...
            <div className="lg:col-span-5 relative h-[500px] w-full flex items-center justify-center">
              {/* Main Tall Image */}
              <div className="absolute top-4 left-4 w-[65%] h-[85%] border border-[#E5E0D8] p-2 bg-white shadow-sm overflow-hidden z-10 rounded-none">
                <img
                  src="https://images.unsplash.com/photo-1506929562872-bb421503ef21?auto=format&fit=crop&w=800&q=80"
                  alt="Luxury Resorts Maldives"
                  className="w-full h-full object-cover rounded-none"
                />
              </div>

              {/* Staggered Offset Image */}
              <div className="absolute bottom-4 right-4 w-[50%] h-[60%] border border-[#E5E0D8] p-2 bg-white shadow-md overflow-hidden z-20 rounded-none">
                <img
                  src="https://images.unsplash.com/photo-1439066615861-d1af74d74000?auto=format&fit=crop&w=600&q=80"
                  alt="Ocean View Sanctuary"
                  className="w-full h-full object-cover rounded-none"
                />
              </div>

              {/* Thin geometric border accent */}
              <div className="absolute top-16 right-16 w-[45%] h-[55%] border border-brand-purple/20 pointer-events-none z-0" />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div className="space-y-2">
              <span className="text-[11px] text-brand-purple font-bold uppercase tracking-[0.25em] font-serif block">02 / Global Curation</span>
            ...
            <div className="flex flex-wrap gap-1">
              {[
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-none text-[9px] font-bold uppercase tracking-widest transition-all border ${
                    destFilter === opt.id
